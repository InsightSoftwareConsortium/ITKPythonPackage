...
# One cp311-abi3 wheel per platform, installable on 3.11 and newer. Pinned
# rather than derived from the interpreter running this driver.
STABLE_ABI_TAG = "cp311"
...
def get_py_api():
    """Return the pinned stable-ABI tag.
