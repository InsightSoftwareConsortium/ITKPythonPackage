...
#   For instance, `export ITK_PACKAGE_VERSION=v6.0a03`.
#
...
echo "Fetching https://github.com/InsightSoftwareConsortium/ITKPythonBuilds/releases/download/${ITK_PACKAGE_VERSION:=v6.0a03}/ITKPythonBuilds-macosx${tarball_arch}.tar.zst"
if [[ ! -f ITKPythonBuilds-macosx${tarball_arch}.tar.zst ]]; then
  aria2c -c --file-allocation=none -o ITKPythonBuilds-macosx${tarball_arch}.tar.zst -s 10 -x 10 https://github.com/InsightSoftwareConsortium/ITKPythonBuilds/releases/download/${ITK_PACKAGE_VERSION:=v6.0a03}/ITKPythonBuilds-macosx${tarball_arch}.tar.zst
fi
